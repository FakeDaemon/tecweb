...
<head>
    ...
    <meta charset="utf-8">
    <title>DOOM | DoomWiki</title>
    <meta name="viewport" content="width=device-width,initial-scale=1.0">
    <meta name="keywords" content="DOOM WIKI, saga, gameplay, release, note legali" />
    <meta name="description" content="DOOM, Tutte le informazioni sul gioco" />
    <meta name="author" content="Antonio Oseliero, Angeli Jacopo, Destro Stefano , Angeloni Alberto" />
</head>

<body>
    <?php
    if (isset($_GET['234713']) || $_COOKIE['FontSize'] === "234713") { ?>
        <style>
          html {
            font-size: 2em;
          }
      ...
      <?php
      } else if (isset($_GET['023741']) || $_COOKIE['FontSize'] === "023741") {
      ?>
        <style>
          html {
            font-size: 3em;
      ...
      <?php
      } else if (isset($_GET['823712']) || $_COOKIE['FontSize'] === "823712") {
        setcookie("FontSize", time() - 60);
        $_COOKIE['FontSize'] = "";
      }
    ...
    <footer id="foot">
      ...
      <div id="SiteMap">
        ...
        <ul>
          ...
          <li>Trama
            <ul>
              <li lang="en" class="on">Doom <abbr title="Primo">I</abbr></li>
